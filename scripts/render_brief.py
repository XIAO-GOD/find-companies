...
.audit-panel{{border-color:#b9d8cb;background:#fbfffd}} .audit-grid{{display:grid;grid-template-columns:repeat(5,1fr);gap:10px}} .audit-grid div{{border:1px solid var(--line);border-radius:12px;padding:14px;background:#fff}} .audit-grid b{{font-size:20px;display:block}} .audit-grid span{{font-size:12px;color:var(--muted)}} .limitations{{margin-top:16px;color:#4e5d56;font-size:13px}} .limitations ul{{margin:6px 0 0;padding-left:20px}}
...
.badge{{font-size:11px;line-height:1;padding:5px 7px;border-radius:999px;white-space:nowrap}} .confirmed{{color:var(--green);background:var(--green2)}} .badge.claim{{color:var(--amber);background:var(--amber2)}} .analysis{{color:var(--blue);background:var(--blue2)}} .unverified{{color:var(--red);background:var(--red2)}} .mini-badge{{font-size:10px;border:1px solid #9dbcb0;color:var(--green);padding:2px 6px;border-radius:999px}} .as-of{{font-size:11px;color:var(--muted)}} .cite{{font-size:11px;margin-left:3px;vertical-align:super}}
